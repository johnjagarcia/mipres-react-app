      ...
      <div className="grid gap-1.5">
        {payload.map((item: LegendPayload, index: number) => {
          ...
          const indicatorColor =
            color ||
            (item.payload && (item.payload as { fill?: string }).fill) ||
            item.color;

          // Aseguramos que item.value sea string o number
          const itemValue =
          ...
          return (
            ...
            >
              {formatter && itemValue !== undefined && itemValue !== null ? (
                (
                  formatter as (
                    value: string | number,
                    name: string | number,
                ...
                )(itemValue, itemValue, item, index, item.payload)
              ) : (
                <>
                  {itemConfig?.icon ? (
                    <itemConfig.icon />
...
// Agregar función de ayuda para mostrar valores
